...
<tr>
<td width="7%" style="min-width:50px;max-width:60px">Menu<br/>icon</td>
...
<tr>
	<td style="min-width:50px;max-width:60px;padding:2px">Menu<br/>functions</td>
...
<tr>
<td style="min-width:50px;max-width:60px;padding:2px">Menu<br/>states</td>
