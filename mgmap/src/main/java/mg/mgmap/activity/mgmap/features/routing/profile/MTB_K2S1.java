...
public class MTB_K2S1 extends RoutingProfile {
    public MTB_K2S1( ) {
        super(new CostCalculatorHeuristicTwoPieceFunc(2,  0, -0.27, 2));
    }


    protected CostCalculator getCostCalculator(CostCalculator profileCalculator, WayAttributs wayAttributs) {
        return new CostCalculatorMTB(wayAttributs, (CostCalculatorHeuristicTwoPieceFunc) profileCalculator, 1.2,0.0,1.2,1.0,0.8,0.5); //0.0,0.0,0.7,0.0,0.7,0.0);
    }
