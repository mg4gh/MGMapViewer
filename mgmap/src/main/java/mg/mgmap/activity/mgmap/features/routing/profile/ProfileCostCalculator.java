...
public class ProfileCostCalculator extends TwoPieceFuncCostCalculator {
    protected double mUpSlopeFactor;
    protected double mDnSlopeFactor;
    protected ProfileCostCalculator(double upCosts, double upSlopeLimit, double upSlopeFactor, double dnCosts, double dnSlopeLimit, double dnSlopeFactor) {
