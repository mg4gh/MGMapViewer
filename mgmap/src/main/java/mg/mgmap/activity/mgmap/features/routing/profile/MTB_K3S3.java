...
//        super(new CostCalculatorHeuristicTwoPieceFunc(8.0, 0.10, 3, 0, -0.27, 2));
        super(new CostCalculatorHeuristicTwoPieceFunc(3,  3, -0.27, 2));
    }

    @Override
    protected CostCalculator getCostCalculator(CostCalculator profileCalculator, WayAttributs wayAttributs) {
        return new CostCalculatorMTB(wayAttributs, (CostCalculatorHeuristicTwoPieceFunc) profileCalculator, 1.3,0.0,2.2,1.0,0.8,1.5); //0.0,0.0,0.7,0.0,0.7,0.0);
    }
